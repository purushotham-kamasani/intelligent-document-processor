...
# SQLite + concurrent transactions don't mix. Real Postgres handles batch
# concurrency cleanly; tests verify orchestration logic, not concurrency
# primitives, so we serialize here for determinism.
os.environ["BATCH_MAX_CONCURRENCY"] = "1"
